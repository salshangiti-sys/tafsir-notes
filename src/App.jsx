...
مهمتك: تحويل الملاحظات التالية إلى JSON أستطيع لصقه مباشرة في تطبيقي.
الصيغة المطلوبة بالضبط — JSON فقط بدون أي نص إضافي:

{"notes":[{"surah":"اسم السورة","ayahFrom":"رقم","ayahTo":"رقم","page":"رقم الصفحة","colorKeys":[],"meaning":"المعنى الإجمالي","masail":["م — نص المسألة","خ — نص المسألة","د — نص المسألة","ت — نص المسألة"],"reflection":"الفوائد وما استوقفني","topics":["موضوع من القائمة فقط"],"tags":["وسم1","وسم2"]}]}

قواعد المسائل:
* كل مسألة تبدأ بحرف نوعها ثم — ثم النص
* م — للأحكام الفقهية
* خ — للخلاصة والترجيح
* د — للأدلة والأحاديث
* ت — للطائف التربوية

قائمة الموضوعات المتاحة فقط: الأسماء والصفات، التوحيد ونفي الشرك، الإيمان بالغيب، الإيمان بالملائكة، الإيمان بالكتب، القضاء والقدر، التوبة والمغفرة، تزكية النفس، الخوف والرجاء، الشكر والصبر، الإخلاص والنية، يوم القيامة وأهواله، الجنة ونعيمها، النار وعذابها، الحساب والميزان، الشفاعة، قصص الأنبياء، قصص الأمم السابقة، العبرة من القصص، العبادات، المعاملات، الأسرة والنكاح، الحدود والعقوبات، طبائع النفس البشرية، الغفلة والتذكير، الابتلاء والاختبار، الموت وسكراته، آيات الكون والطبيعة، الخلق والتدبير، التفكر والتأمل، صفات المنافقين، صفات الكافرين، مصير المكذبين، الأمر بالمعروف والنهي عن المنكر، العلاقة مع غير المسلمين، الجهاد والدفاع

قواعد مهمة:
* أعد JSON فقط، بدون أي نص قبله أو بعده
* إذا كانت ملاحظات لآيات متعددة أضف object جديد داخل مصفوفة notes
* الموضوعات من القائمة أعلاه فقط
* إذا لم تجد معلومة اترك الحقل فارغاً
